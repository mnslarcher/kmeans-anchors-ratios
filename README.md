...
output:
```
2020-05-17 17:30:09 Starting the calculation of the optimal anchors ratios
...
2020-05-17 17:31:47 Optimal anchors ratios (avg. IoU: 80.48%): [(0.6, 1.5), (1.0, 1.0), (1.4, 0.7)]
```
